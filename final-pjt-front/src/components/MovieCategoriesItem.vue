<template>
  <!-- <div @click="toMovieDetail(movie.id)">
    <div class="card mx-auto" style="width:18em; height:30rem">
    <img :src="'http://image.tmdb.org/t/p/w500/'+ movie.poster_path" alt="" style="height:20em">
    <div class="card-body">
